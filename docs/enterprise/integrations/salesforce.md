...
Salesforce requires a **one-time admin install** of the CrewAI package in your org before any user can connect. This is a Salesforce platform requirement for all ExternalClientApp-based integrations as of the Spring ‘26 release — not a CrewAI-specific step. The Connect Salesforce flow in CrewAI AMP walks you through it the first time.
...
The first time anyone in your org clicks **Connect Salesforce** , CrewAI redirects them to an install page that points at the CrewAI managed package. A Salesforce admin needs to install it once for the whole org.

  1. On the install page in CrewAI, click **Install in Salesforce**. (You can also share the page URL with your admin — the install link works for anyone who opens it.)
  2. Sign in to Salesforce as an admin. For sandboxes, swap `login.salesforce.com` for `test.salesforce.com` in the URL before opening it.
  3. Choose **Install for All Users** , acknowledge the third-party app prompt, and click **Install**.
  4. In Salesforce Setup, search **External Client App Manager** → **CrewAI App** → open the **Policies** tab → **Edit** and set:
     * **Permitted Users:** All users may self-authorize
     * **IP Relaxation:** Relax IP restrictions
     * **Refresh Token Policy:** Refresh token is valid until revoked
  5. Save.
  6. Return to CrewAI AMP and click **Connect Salesforce** again. OAuth will complete this time.

**Not a Salesforce admin?** Forward the install page URL (or the install link itself) to your Salesforce admin and ask them to complete the steps above. Once they’re done, return to CrewAI AMP and click **Connect** again.
...
**Description:** Create a new Contact record in Salesforce.**Parameters:**
...
**Description:** Create a new Lead record in Salesforce.**Parameters:**
...
**Description:** Create a new Opportunity record in Salesforce.**Parameters:**
...
**Description:** Create a new Task record in Salesforce.**Parameters:**
...
**Description:** Create a new Account record in Salesforce.**Parameters:**
...
**Description:** Create a record of any object type in Salesforce.**Note:** This is a flexible tool for creating records of custom or unknown object types.
...
**Description:** Update an existing Contact record in Salesforce.**Parameters:**
...
**Description:** Update an existing Lead record in Salesforce.**Parameters:**
...
**Description:** Update an existing Opportunity record in Salesforce.**Parameters:**
...
**Description:** Update an existing Task record in Salesforce.**Parameters:**
...
**Description:** Update an existing Account record in Salesforce.**Parameters:**
...
**Description:** Update a record of any object type in Salesforce.**Note:** This is a flexible tool for updating records of custom or unknown object types.
...
**Description:** Search for Contact records with advanced filtering.**Parameters:**
...
**Description:** Search for Lead records with advanced filtering.**Parameters:**
...
**Description:** Search for Opportunity records with advanced filtering.**Parameters:**
...
**Description:** Search for Task records with advanced filtering.**Parameters:**
...
**Description:** Search for Account records with advanced filtering.**Parameters:**
...
**Description:** Search for records of any object type.**Parameters:**
...
**Description:** Get Contact records from a specific List View.**Parameters:**
...
**Description:** Get Lead records from a specific List View.**Parameters:**
...
**Description:** Get Opportunity records from a specific List View.**Parameters:**
...
**Description:** Get Task records from a specific List View.**Parameters:**
...
**Description:** Get Account records from a specific List View.**Parameters:**
...
**Description:** Get records of any object type from a specific List View.**Parameters:**
...
**Description:** Deploy custom fields for Contact objects.**Parameters:**
...
**Description:** Deploy custom fields for Lead objects.**Parameters:**
...
**Description:** Deploy custom fields for Opportunity objects.**Parameters:**
...
**Description:** Deploy custom fields for Task objects.**Parameters:**
...
**Description:** Deploy custom fields for Account objects.**Parameters:**
...
**Description:** Deploy custom fields for any object type.**Note:** This is a flexible tool for creating custom fields on custom or unknown object types.
...
**Description:** Execute custom SOQL queries against your Salesforce data.**Parameters:**

  * `query` (string, required): SOQL Query (e.g., “SELECT Id, Name FROM Account WHERE Name = ‘Example’”)

salesforce/create_custom_object

**Description:** Deploy a new custom object in Salesforce.**Parameters:**
...
**Description:** Get the expected schema for operations on specific object types.**Parameters:**
...
[Notion IntegrationPrevious](/en/enterprise/integrations/notion)[Shopify IntegrationNext](/en/enterprise/integrations/shopify)
