...
This command installs the necessary package to run the GithubSearchTool along with any other tools included in the crewai_tools package. Get a GitHub Personal Access Token at <https://github.com/settings/tokens> (Developer settings → Fine‑grained tokens or classic tokens).
...
[Linkup Search ToolPrevious](/en/tools/search-research/linkupsearchtool)[Website RAG SearchNext](/en/tools/search-research/websitesearchtool)
