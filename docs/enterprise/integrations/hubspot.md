...
**Description:** Create a new company record in HubSpot.**Parameters:**
...
**Description:** Create a new contact record in HubSpot.**Parameters:**
...
**Description:** Create a new deal record in HubSpot.**Parameters:**
...
**Description:** Create a new engagement (e.g., note, email, call, meeting, task) in HubSpot.**Parameters:**
...
**Description:** Update an existing company record in HubSpot.**Parameters:**
...
**Description:** Create a record for a specified object type in HubSpot.**Parameters:**
...
**Description:** Update an existing contact record in HubSpot.**Parameters:**
...
**Description:** Update an existing deal record in HubSpot.**Parameters:**
...
**Description:** Update an existing engagement in HubSpot.**Parameters:**
...
**Description:** Update a record for a specified object type in HubSpot.**Parameters:**
...
**Description:** Get a list of company records from HubSpot.**Parameters:**

  * `paginationParameters` (object, optional): Use `pageCursor` to fetch subsequent pages.

hubspot/list_contacts

**Description:** Get a list of contact records from HubSpot.**Parameters:**

  * `paginationParameters` (object, optional): Use `pageCursor` to fetch subsequent pages.

hubspot/list_deals

**Description:** Get a list of deal records from HubSpot.**Parameters:**

  * `paginationParameters` (object, optional): Use `pageCursor` to fetch subsequent pages.

hubspot/get_records_engagements

**Description:** Get a list of engagement records from HubSpot.**Parameters:**
...
**Description:** Get a list of records for any specified object type in HubSpot.**Parameters:**
...
**Description:** Get a single company record by its ID.**Parameters:**

  * `recordId` (string, required): The ID of the company to retrieve.

hubspot/get_contact

**Description:** Get a single contact record by its ID.**Parameters:**

  * `recordId` (string, required): The ID of the contact to retrieve.

hubspot/get_deal

**Description:** Get a single deal record by its ID.**Parameters:**

  * `recordId` (string, required): The ID of the deal to retrieve.

hubspot/get_record_by_id_engagements

**Description:** Get a single engagement record by its ID.**Parameters:**

  * `recordId` (string, required): The ID of the engagement to retrieve.

hubspot/get_record_by_id_any

**Description:** Get a single record of any specified object type by its ID.**Parameters:**
...
**Description:** Search for company records in HubSpot using a filter formula.**Parameters:**
...
**Description:** Search for contact records in HubSpot using a filter formula.**Parameters:**
...
**Description:** Search for deal records in HubSpot using a filter formula.**Parameters:**
...
**Description:** Search for engagement records in HubSpot using a filter formula.**Parameters:**
...
**Description:** Search for records of any specified object type in HubSpot.**Parameters:**
...
**Description:** Get contacts from a specific list by its ID.**Parameters:**
...
**Description:** Get the expected schema for a given object type and operation.**Parameters:**
...
[Google Slides IntegrationPrevious](/en/enterprise/integrations/google_slides)[Jira IntegrationNext](/en/enterprise/integrations/jira)
