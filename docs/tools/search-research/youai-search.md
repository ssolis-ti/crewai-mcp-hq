# Source: https://docs.crewai.com/en/tools/search-research/youai-search
...
Web search and AI-powered research via You.com’s remote MCP server — includes a free tier with 100 queries/day.
...
[Databricks SQL Query ToolPrevious](/en/tools/search-research/databricks-query-tool)[OverviewNext](/en/tools/database-data/overview)
