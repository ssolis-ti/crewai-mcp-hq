# Source: https://docs.crewai.com/en/enterprise/features/secrets-manager/aws-workload-identity
...
Configure AWS Secrets Manager via Workload Identity for rotation-aware, credential-free secret access
...
[AWS Secrets Manager (Static Credentials)Previous](/en/enterprise/features/secrets-manager/aws)[Google Cloud Secret ManagerNext](/en/enterprise/features/secrets-manager/gcp)
