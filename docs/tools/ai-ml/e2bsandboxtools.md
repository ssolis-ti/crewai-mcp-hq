# Source: https://docs.crewai.com/en/tools/ai-ml/e2bsandboxtools
...
The `E2BExecTool`, `E2BPythonTool`, and `E2BFileTool` give CrewAI agents shell, Python, and filesystem access inside isolated, ephemeral E2B remote sandboxes.
...
[Daytona Sandbox ToolsPrevious](/en/tools/ai-ml/daytona)[OverviewNext](/en/tools/cloud-storage/overview)
