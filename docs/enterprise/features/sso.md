# Source: https://docs.crewai.com/en/enterprise/features/sso
...
**Symptom:** Users can’t log in, see “needs admin approval” message. **Fix:** Go to **Enterprise applications** → your app → **Permissions** → **Grant admin consent**. Ensure `User.Read` is granted for Microsoft Graph.
...
[Flow HITL ManagementPrevious](/en/enterprise/features/flow-hitl-management)[Role-Based Access Control (RBAC)Next](/en/enterprise/features/rbac)
