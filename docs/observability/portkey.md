...
To create a virtual key: Go to [Virtual Keys](https://app.portkey.ai/virtual-keys) in the Portkey App. Save and copy the virtual key ID
...
[Patronus AI EvaluationPrevious](/en/observability/patronus-evaluation)[Weave IntegrationNext](/en/observability/weave)
