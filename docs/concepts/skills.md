# Source: https://docs.crewai.com/en/concepts/skills
...
**Skills are NOT tools.** This is the most common point of confusion.
  ...
  * **Skills** inject _instructions and context_ into the agent’s prompt. They tell the agent _how to think_ about a problem.
  * **Tools** give the agent _callable functions_ to take action (search, read files, call APIs).
...
The most common real-world pattern. The skill provides _how_ to approach the work; tools provide _what_ the agent can do:
...
**Rule of thumb:** If the agent needs to follow a _process_ , use a skill. If the agent needs to reference _data_ , use knowledge.
...
[KnowledgePrevious](/en/concepts/knowledge)[LLMsNext](/en/concepts/llms)
