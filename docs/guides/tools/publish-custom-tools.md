# Source: https://docs.crewai.com/en/guides/tools/publish-custom-tools
...
[Migrating from inputs.id to restore_from_state_idPrevious](/en/guides/flows/inputs-id-deprecation)[Coding ToolsNext](/en/guides/coding-tools/agents-md)
