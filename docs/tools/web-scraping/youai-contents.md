# Source: https://docs.crewai.com/en/tools/web-scraping/youai-contents
...
Extract full page content from URLs in markdown, HTML, or metadata format via You.com’s remote MCP server.
...
[Bright Data ToolsPrevious](/en/tools/web-scraping/brightdata-tools)[OverviewNext](/en/tools/search-research/overview)
